...
import uit.carbon_shop.config.BaseIntegrationTestByTestContainer;
import uit.carbon_shop.model.UserStatus;
import uit.carbon_shop.repos.AppUserRepository;

@TestMethodOrder(OrderAnnotation.class)
@Sql(value = {"/data/clearAll.sql", "/data/companyData.sql",
        "/data/appUserData.sql"}, executionPhase = ExecutionPhase.BEFORE_TEST_CLASS)
@Tag("TestContainer")
public class TestContainerTest extends BaseIntegrationTestByTestContainer {
